...
class SchoolsController extends Controller
{
    ...
    /**
     * Probni metod (ackcija) hello
     */
    public function actionHello()
    {
        $ime_prom = 'Johnny';
        return $this->render('hello', array('ime_prom'=>$ime_prom));
    }
    
    /**
     * Akcija za probnu formu UserForm
     */
    public function actionUserform()
    {
        ...
        if($model->load(Yii::$app->request->post()) && $model->validate()){
            Yii::$app->session->setFlash('success', 'Pravilno ste ispunili formu!');
        }
